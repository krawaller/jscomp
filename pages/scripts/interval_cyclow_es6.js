...
/***/ function(module, exports, __webpack_require__) {
	...
	var _singer = __webpack_require__(2);

	var _singer2 = _interopRequireDefault(_singer);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	(0, _cyclow.run)(_singer2.default, { target: 'app' });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Singer = function Singer() {
	  return (0, _cyclow.Block)({
	    components: { ticker: (0, _graflow.Ticker)(1500, { initialDelay: true }) },
	    events: {
	      init: function init() {
	        return [['state', function (pos) {
	          return 0;
	        }], 'ticker'];
	      },
