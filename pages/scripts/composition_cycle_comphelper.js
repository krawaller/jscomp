...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _xstreamRun.run)(_app2.default, { DOM: (0, _dom.makeDOMDriver)('#app') });
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var thunk = __webpack_require__(7);
	exports.thunk = thunk;
	/**
	 ...
	 */
	var makeDOMDriver_1 = __webpack_require__(11);
	 ...
	 */
	var makeHTMLDriver_1 = __webpack_require__(36);
	 ...
	 */
	var mockDOMSource_1 = __webpack_require__(65);
	 ...
	 * @function h
	 */
	var hyperscript_1 = __webpack_require__(23);
	exports.h = hyperscript_1.h;
	var hyperscript_helpers_1 = __webpack_require__(66);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var VNodeWrapper_1 = __webpack_require__(22);
	var utils_1 = __webpack_require__(17);
	var modules_1 = __webpack_require__(27);
	var isolateModule_1 = __webpack_require__(34);
	var transposition_1 = __webpack_require__(35);
	var xstream_adapter_1 = __webpack_require__(5);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var xstream_adapter_1 = __webpack_require__(5);
	var xstream_1 = __webpack_require__(1);
	var ElementFinder_1 = __webpack_require__(15);
	var fromEvent_1 = __webpack_require__(19);
	var isolate_1 = __webpack_require__(20);
	var EventDelegator_1 = __webpack_require__(21);
	var utils_1 = __webpack_require__(17);
	var matchesSelector;
	try {
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var ScopeChecker_1 = __webpack_require__(16);
	var utils_1 = __webpack_require__(17);
	var matchesSelector;
	try {
	    matchesSelector = __webpack_require__(18);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var hyperscript_1 = __webpack_require__(23);
	var classNameFromVNode_1 = __webpack_require__(24);
	var selectorParser_1 = __webpack_require__(25);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _selectorParser2 = __webpack_require__(25);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _browserSplit = __webpack_require__(26);
...
/***/ function(module, exports, __webpack_require__) {
	...
	"use strict";
	var ClassModule = __webpack_require__(28);
	exports.ClassModule = ClassModule;
	var PropsModule = __webpack_require__(29);
	exports.PropsModule = PropsModule;
	var AttrsModule = __webpack_require__(30);
	exports.AttrsModule = AttrsModule;
	var EventsModule = __webpack_require__(31);
	exports.EventsModule = EventsModule;
	var StyleModule = __webpack_require__(32);
	exports.StyleModule = StyleModule;
	var HeroModule = __webpack_require__(33);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var xstream_adapter_1 = __webpack_require__(5);
	var transposition_1 = __webpack_require__(35);
	var HTMLSource_1 = __webpack_require__(37);
	var toHTML = __webpack_require__(38);
	/* tslint:disable:no-empty */
	var noop = function () { };
	/* tslint:enable:no-empty */
...
/***/ function(module, exports, __webpack_require__) {
	...
	var init = __webpack_require__(39);

	module.exports = init([__webpack_require__(43), __webpack_require__(61)]);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var parseSelector = __webpack_require__(40);
	var VOID_ELEMENTS = __webpack_require__(41);
	var CONTAINER_ELEMENTS = __webpack_require__(42);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var forOwn = __webpack_require__(44);
	var escape = __webpack_require__(51);
	var union = __webpack_require__(54);
...
/***/ function(module, exports, __webpack_require__) {
	 ...
	 * Available under MIT license <https://lodash.com/license>
	 */
	var deburr = __webpack_require__(63),
	    words = __webpack_require__(64);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function view(_ref) {
	  var _ref$childsinks = _ref.childsinks;
	  var submit$ = _ref$childsinks.submit$;
	  var DOM = _ref$childsinks.DOM;

	  return _xstream2.default.combine(submit$.startWith('Steve'), DOM).map(function (_ref2) {
	    var _ref3 = _slicedToArray(_ref2, 2);

	    var submission = _ref3[0];
	    var childvtree = _ref3[1];
	    return (0, _dom.div)([childvtree, (0, _dom.p)('Submitted value: ' + submission)]);
	  });
	}
	...
	function App(sources) {
	  return {
	    DOM: view(sources),
	    instruction$: _xstream2.default.of('Enter name')
	  };
	}

	exports.default = (0, _helper2.default)(App, _field2.default, 'instruction$');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var intent = function intent(DOM, confirm$) {
	  var input$ = DOM.select('.field').events('input');
	  var newValue$ = input$.map(function (e) {
	    return { type: 'INPUT', data: e.target.value };
	  });
	  var submit$ = input$.map(function (i) {
	    return confirm$.map(function (s) {
	      return { type: 'SUBMIT', data: i.target.value };
	    });
	  }).flatten();
	  return _xstream2.default.merge(submit$, newValue$);
	};

	var model = function model(action$) {
	  return action$.fold(function (state, action) {
	    switch (action.type) {
	      case 'INPUT':
	        return _extends({}, state, { input: action.data });
	      case 'SUBMIT':
	        return { submission: action.data, input: '' };
	      default:
	        return state;
	    }
	  }, { submission: '', input: '' });
	...
	var view = function view(state$, confirmvtree$, instruction$) {
	  return _xstream2.default.combine(state$, confirmvtree$, instruction$).map(function (_ref) {
	    var _ref2 = _slicedToArray(_ref, 3);

	    var state = _ref2[0];
	    var confirmvtree = _ref2[1];
	    var instruction = _ref2[2];
	    return (0, _dom.div)('.child', [instruction + ': ', (0, _dom.input)('.field', { props: { value: state.input } }), confirmvtree]);
	  });
	};

	function Field(sources) {
	  var action$ = intent(sources.DOM, sources.childsinks.confirm$);
	  var state$ = model(action$);
	  var vtree$ = view(state$, sources.childsinks.DOM, sources.instruction$);
	  return {
	    DOM: vtree$,
	    submit$: action$.filter(function (a) {
	      return a.type === 'SUBMIT';
	    }).map(function (a) {
	      return a.data;
	    }),
	    disabled$: action$.map(function (a) {
	      return a.type === 'SUBMIT' || !a.data;
	    })
	  };
	}

	exports.default = (0, _helper2.default)(Field, _confirm2.default, 'disabled$');
...
/***/ function(module, exports, __webpack_require__) {
	...
	var intent = function intent(sources) {
	  return _xstream2.default.merge(sources.disabled$.map(function (i) {
	...
	var model = function model(action$) {
	  return action$.fold(function (s, action) {
	    switch (action) {
	      case 'DISABLE':
	        return 'disabled';
	      case 'MAYBE':
	...
	var view = function view(state$) {
	  return state$.map(function (state) {
	    return state === 'confirm' ? (0, _dom.span)([(0, _dom.button)('.confirm', 'Confirm'), (0, _dom.button)('.cancel', 'Cancel')]) : (0, _dom.button)('.maybe', { attrs: { disabled: state === 'disabled' } }, 'Submit');
	  });
	};
	...
	exports.default = function (sources) {
	  ...
	  return {
	    DOM: vtree$,
	    confirm$: action$.filter(function (i) {
	      return i === 'CONFIRM';
	    })
	  };
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _extends = Object.assign || function (target) { for (var i = 1; i < arguments.length; i++) { var source = arguments[i]; for (var key in source) { if (Object.prototype.hasOwnProperty.call(source, key)) { target[key] = source[key]; } } } return target; }; // a helper function for CycleJS composition
	...
	exports.default = function (parent, child) {
	  ...
	  return function (sources) {
	    var proxies = dependencies.reduce(function (proxies, dep) {
	      return _extends({}, proxies, _defineProperty({}, dep, _xstream2.default.create()));
	    }, {});
	    var childsinks = child(_extends({}, sources, proxies));
	    var sinks = parent(_extends({}, sources, _defineProperty({}, 'childsinks', childsinks)));
	    Object.keys(proxies).forEach(function (proxy) {
	      return proxies[proxy].imitate(sinks[proxy]);
	    });
	    return sinks;
	  };
	};
