...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _cyclow.run)(_form2.default, { target: 'app' });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Form = function Form() {
	  return (0, _cyclow.Block)({
	    components: { field: (0, _field2.default)() },
	    on: {
	      init: function init() {
	        return [['field.init', 'Enter name'], function (state) {
	          return { current: 'Steve' };
	        }];
	      },
	      'field.submission': function fieldSubmission(submission) {
	    ...
	    view: function view(_ref, _ref2) {
	      ...
	      return {
	        content: [field, { tag: 'p', content: 'Submitted value: ' + current }],
	        attrs: { id: 'app' }
	      };
	    }
	  });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Field = function Field() {
	  return (0, _cyclow.Block)({
	    outputs: ['submission'],
	    components: { confirm: (0, _confirm2.default)() },
	    on: {
	      init: function init(instruction) {
	        return [function (state) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var viewConfirm = function viewConfirm() {
	  return [{ tag: 'button', content: 'Confirm', on: { click: 'confirm' } }, { tag: 'button', content: 'Cancel', on: { click: 'cancel' } }];
	};

	var viewDefault = function viewDefault(mode) {
	  return {
	    tag: 'button',
	    content: 'Submit',
	...
	var Confirm = function Confirm() {
	  return (0, _cyclow.Block)({
	    ...
	    on: {
	      ...
	      disabled: function disabled(_disabled, _ref) {
	        var mode = _ref.mode;
	    ...
	    view: function view(_ref2) {
	      var mode = _ref2.mode;
	      return mode === 'confirm' ? viewConfirm() : viewDefault(mode);
	    }
	  });
	};
